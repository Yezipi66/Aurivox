...
from gsv_code.module import attentions
try:
...
from gsv_code.module.commons import init_weights, get_padding
from gsv_code.module.mrte_model import MRTE
from gsv_code.module.quantize import ResidualVectorQuantizer

# from gsv_code.text import symbols
from gsv_code.text import symbols as symbols_v1
from gsv_code.text import symbols2 as symbols_v2
...
class SynthesizerTrn(nn.Module):
    ...
    def forward(self, ssl, y, y_lengths, text, text_lengths, sv_emb=None):
        ...
        x, m_p, logs_p, y_mask, _, _ = self.enc_p(quantized, y_lengths, text, text_lengths, ge512)
    ...
    def infer(self, ssl, y, y_lengths, text, text_lengths, test=None, noise_scale=0.5):
        ...
        ge512 = self.ge_to512(ge.transpose(2, 1)).transpose(2, 1)
        x, m_p, logs_p, y_mask, _, _ = self.enc_p(quantized, y_lengths, text, text_lengths, ge512, test=test)

...
if os.path.exists(semantic_path) == False:
    ...
    # Remove version from hps.model to avoid conflict with explicit version param;
    # use the auto-detected version (based on pretrained model size) instead.
    model_kwargs = dict(hps.model)
    model_kwargs.pop("version", None)

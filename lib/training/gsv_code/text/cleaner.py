...
#     from gsv_code.text.symbols import symbols
# else:
#     from gsv_code.text import chinese2 as chinese
...
def clean_text(text, language, version=None):
    ...
    language_module = __import__("gsv_code.text." + language_module_map[language], fromlist=[language_module_map[language]])

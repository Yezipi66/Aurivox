...
const GSV_CODE_DIR = envDir('GSV_CODE_DIR', path.join(TRAINING_DIR, 'gsv_code'));
...
// 余下各项属第 3 步（权重迁入 models/）与第 4 步（第三方代码迁入 vendor/）。
...
const LEGACY_LOCATIONS = Object.freeze({
  ...
  gsvCode: { current: GSV_CODE_DIR, target: path.join(VENDOR_DIR, 'gpt-sovits') },

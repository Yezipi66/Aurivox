...
// 第 4 步（第三方代码迁入 vendor/）中 gsv-tools 与 gsv_code 已落位，同样移除。
// 余下各项属第 3 步（权重迁入 models/）与第 4 步尚未搬迁的推理端。
...
const LEGACY_LOCATIONS = Object.freeze({
  ...
  // 第三方代码 —— 第 4 步。涉及 Python 的 sys.path，风险最高，单独一轮做。
  inference: { current: INFERENCE_DIR, target: VENDOR_DIR },
});
...
module.exports = {
  ...
  WEB_DIST,
  // 训练、推理与权重
  TRAINING_DIR, INFERENCE_DIR, GSV_CODE_DIR, GSV_TOOLS_DIR,

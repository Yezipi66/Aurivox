...
class HttpError extends Error {
  ...
  constructor(status, error, extra, headers) {
    ...
    // Optional response headers (e.g. Retry-After on a 503). Applied by
    // asyncHandler before the JSON body is sent. Backward compatible: existing
    // 2-3 arg call sites leave this undefined and set no extra headers.

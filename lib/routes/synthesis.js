  ...
  if (typeof voice === "string" && voice.includes("/")) {
    ...
    if (reqLang) {
      ...
      if (reqLangUnsupported) {
        langWarning = `Requested language '${reqLangUnsupported}' is not supported (supported: zh, yue, ja, en, ko, auto - or canonical all_zh/all_yue/all_ja/all_ko/auto_zh_ja); text_lang fell back to 'auto'.`;

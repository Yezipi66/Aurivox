...
function createRecipeStore(recipesDir) {
  ...
  function normalize(payload, existing) {
    ...
    if (typeof payload.reference_audio === "string" &&
        (payload.reference_audio.includes("..") ||
         payload.reference_audio.startsWith("/") ||
         payload.reference_audio.includes(":\\"))) {
    ...
    const params = {
      top_k: srcParams.top_k != null ? srcParams.top_k : 15,
      top_p: srcParams.top_p != null ? srcParams.top_p : 1.0,
      temperature: srcParams.temperature != null ? srcParams.temperature : 1.0,
      speed: srcParams.speed != null ? srcParams.speed : 1.0,
    };

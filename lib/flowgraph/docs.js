  ...
  'io.engine': {
    ...
    params: {
      engine_id: {
        ...
        help: { en: 'Which engine adapter to use. Only gpt-sovits is implemented so far.', zh: '使用哪个引擎适配器，目前仅实现 gpt-sovits。' },
        choices: [{ value: 'gpt-sovits', label: { en: 'GPT-SoVITS', zh: 'GPT-SoVITS' } }],
      },
      voice: {

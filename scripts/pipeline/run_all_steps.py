...
print(f"\n  2-name2text-0.txt: {os.path.exists(n2t_0)}, 3-bert/: {bert_files} files")

if not os.path.exists(n2t_0) or bert_files == 0:
    print("  WARNING: Step 1 output missing!")
    sys.exit(1)
...
print(f"\n  6-name2semantic.tsv: {os.path.exists(semantic)}")

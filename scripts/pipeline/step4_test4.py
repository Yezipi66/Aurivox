...
# S1 config - CORRECT values matching checkpoint
s1_config = {
    "train": {
    ...
    "model": {
        "vocab_size": 1025,        # Must match EOS+1 (from audio embedding)
        "phoneme_vocab_size": 732, # From text embedding shape
        "embedding_dim": 512,
        "hidden_dim": 512,
        "head": 16,
        "linear_units": 2048,
...
print("=== Step 4: S1 Training (1 epoch, fixed vocab_size) ===", flush=True)

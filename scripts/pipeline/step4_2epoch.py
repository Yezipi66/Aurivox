...
s1_config = {
    "train": {
        "seed": 1234, "epochs": 2, "batch_size": 8,
...
print("=== S1: 2 epochs test ===", flush=True)
...
for line in proc.stdout:
    if 'Epoch' in line or 'Exit' in line or 'checkpoint' in line.lower() or 'error' in line.lower() or 'Traceback' in line:

...
# S1 config - data at TOP level (required by Text2SemanticDataModule)
s1_config = {
    "train": {
    ...
    "data": {
        "max_eval_sample": 8, "max_sec": 54, "num_workers": 4, "pad_val": 1024,
    },
    "model": {
...
print("=== Step 4: S1 Training (1 epoch, data at top level) ===", flush=True)
